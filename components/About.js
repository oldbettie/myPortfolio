  ...
  return (
    <div id="about">
      ...
      <div>
        ...
        <p>
          I consider myself a &quot;maker&quot; someone that loves building and
          creation, I could be building the next big app, a game, designing some
          new handy 3d printed components. I once built from the ground up a van
          life van with a dream tech setup that I lived in while I traveled
          America for a year. I am someone that finds value in learning and
          evolving even if it&apos;s the small things.
        </p>
        <p>
